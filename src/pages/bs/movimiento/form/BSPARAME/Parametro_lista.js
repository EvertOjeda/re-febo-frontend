...
const url_lista         = '/bs/parametros/';
const urlBuscador       = "/bs/parametros/search";
...
const columns = [
    ...
    { ID: "COD_MODULO"     , label: "Modulo"         , minWidth:100, width:100, align: "left", alignID: "left"},
    { ID: "DESCRIPCION"    , label: "Descripción"    , minWidth:400, width:400, align: "left", alignID: "left"},
    { ID: "VALOR"          , label: "Valor"          , minWidth: 200, width:250, align: "left", alignID: "left"},
];

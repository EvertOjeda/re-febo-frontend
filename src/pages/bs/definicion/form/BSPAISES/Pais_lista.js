...
const Titulo            = "Paises";
const url_lista         = '/bs/pais/';
const urlBuscador       = "/bs/paises/search";
const columBuscador     = 'DESCRIPCION';
const doNotsearch       = ['ESTADO'];
const notOrderByAccion  = ['ACCION'];
const idACCION          = 'ACCIONES';
const columns = [
    { ID: 'COD_PAIS'   		, label: 'Codigo'        	, minWidth: 50   ,align: 'left'},
    { ID: 'DESCRIPCION'   	, label: 'Descricion' 		, minWidth: 250  ,align: 'left'},
    { ID: 'NACIONALIDAD'   	, label: 'Nacionalidad'     , minWidth: 150  ,align: 'left'},
    { ID: 'ESTADO'		    , label: 'Estado'   		, minWidth: 150  , width: 100, checkbox:true, options:['A'],align: 'center', alignID:'right'  },
];
const defaultOpenKeys     = ['BS','BS-BS1'];
const defaultSelectedKeys = ['BS-BS1-null-BSPAISES'];
const FormName            = 'BSPAISES';
export default () =>{
    const url_base      = '/bs/paises/';

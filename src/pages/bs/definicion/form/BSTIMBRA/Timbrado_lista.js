...
const Titulo            = "Timbrados";
const url_lista         = '/bs/timbrado/';
const columBuscador     = 'NRO_TIMBRADO';
const doNotsearch       = ['ACTIVO'];
const notOrderByAccion  = ['ACCION'];
const idACCION          = 'ACCIONES';
const columns = [
    { ID: "NRO_TIMBRADO"   , label: "Timbrado"       , width:100 },
    { ID: "FEC_INICIAL"    , label: "Fecha Inicial"  , minWidth: 150, width:150, align: "left" },
    { ID: "FEC_FINAL"      , label: "Fecha Final"    , minWidth: 150, width:150, align: "left" },
    { ID: "NRO_INICIAL"    , label: "Nro. Inicial"   , minWidth: 150, width:150, align: "right", alignID: "right" , format:'number' },
    { ID: "NRO_FINAL"      , label: "Nro. Final"     , minWidth: 150, width:150, align: "right", alignID: "right" , format:'number' },
    { ID: "ACTIVO"         , label: "Estado"         , width:80     , align: "center", alignID: "right" , checkbox:true, options:['S'] }
];
const defaultOpenKeys     = sessionStorage.getItem("mode") == 'vertical' ? [] : ['BS','BS-BS1'];
const defaultSelectedKeys = sessionStorage.getItem("mode") == 'vertical' ? [] : ['BS-BS1-null-BSTIMBRA'];
const FormName            = 'BSTIMBRA';
export default () => {
    const urlBuscador   = "/bs/timbrados/search/" + sessionStorage.getItem('cod_empresa');
    const url_base      = "/bs/timbrados/" + sessionStorage.getItem('cod_empresa');

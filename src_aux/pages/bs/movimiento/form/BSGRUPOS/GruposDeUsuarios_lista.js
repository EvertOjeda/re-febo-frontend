...
const url_lista         = '/bs/grupos_de_usuarios/';
const urlBuscador       = "/bs/grupos_de_usuarios/search";
const columBuscador     = 'DESCRIPCION';
const doNotsearch       = ['ACCION'];
const notOrderByAccion  = ['ACCION'];
const idACCION          = 'ACCIONES';
const columns = [
    { ID: "COD_GRUPO"       , label: "Código "        , width:100},
    { ID: "DESCRIPCION"     , label: "Descripcion"    , minWidth: 250 },
];
const defaultOpenKeys     = sessionStorage.getItem("mode") == 'vertical' ? [] : ['BS','BS-BS2','BS-BS2-BS21'];
const defaultSelectedKeys = sessionStorage.getItem("mode") == 'vertical' ? [] : ['BS-BS2-BS21-BSGRUPOS'];
const FormName            = 'BSGRUPOS';
export default () => {
    const url_base      = "/bs/grupos_de_usuarios/"

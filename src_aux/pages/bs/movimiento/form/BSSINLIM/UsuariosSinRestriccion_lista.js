...
const url_lista         = '/bs/usuarios_sin_restriccion/';
...
const columns = [
    ...
    { ID: "NOMBRE"          , label: "Nombre y Apellido"         , minWidth: 120},
    { ID: "ESTADO"          , label: "Estado"         , width:100, align: "center", alignID:"center" , checkbox:true, options:['A']},
];  
...
export default () => {
    const urlBuscador   = "/bs/usuarios_sin_restriccion/search/" + sessionStorage.getItem('cod_empresa');
    const url_base      = "/bs/usuarios_sin_restriccion/" + sessionStorage.getItem('cod_empresa');

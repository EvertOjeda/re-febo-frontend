...
const urlBuscador       = "/bs/barrios/search";
const columBuscador     = 'DESCRIPCION';
const doNotsearch       = ['ACCION'];
const notOrderByAccion  = ['ACCION'];
const idACCION          = 'ACCIONES';
const columns = [
    { ID: "COD_BARRIO"     , label: "Codigo"       , width:100     },
    { ID: "DESCRIPCION"    , label: "Descrición"   , minWidth: 150 },
    { ID: "DESC_DPTO"      , label: "Departamento" , minWidth: 150 },
    { ID: "DESC_CIUDAD"    , label: "Ciudad"       , minWidth: 150 }
];
const defaultOpenKeys     = ['BS','BS-BS1'];
const defaultSelectedKeys = ['BS-BS1-null-BSBARRIO'];
const FormName            = 'BSBARRIO';
const TreeView = () => {
    const url_base      = '/bs/barrios/';

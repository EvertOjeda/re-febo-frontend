...
const url_lista         = '/bs/calendario/';
const columBuscador     = 'DESC_SUCURSAL';
const doNotsearch       = ['ACTIVO'];
const notOrderByAccion  = ['ACCION'];
const idACCION          = 'ACCIONES'; 
const columns = [
    { ID: "COD_SUCURSAL"    , label: "Codigo"         , width:100},
    { ID: "DESC_SUCURSAL"   , label: "Descripcion"    , minWidth: 150, align: "left", alignID: "left"},
    { ID: "COD_MODULO"      , label: "Módulo"         , width:100,  align: "left", alignID: "left"},
    { ID: "DESC_MODULO"     , label: "Descripcion"    , minWidth: 150, align: "left", alignID: "left"},
    { ID: "FEC_INICIAL"     , label: "Fecha Inicial"  , minWidth: 200, width:100, align: "left", alignID: "left"},
    { ID: "FEC_FINAL"       , label: "Fecha Final"    , minWidth: 200, width:100, align: "left", alignID: "left"},
    { ID: "ACTIVO"          , label: "Activo"         , width:100, align: "center",alignID: "right" , checkbox:true, options:['S']}
];
const defaultOpenKeys     = sessionStorage.getItem("mode") == 'vertical' ? [] : ['BS','BS-BS1'];
const defaultSelectedKeys = sessionStorage.getItem("mode") == 'vertical' ? [] : ['BS-BS1-null-BSCALEN'];
const FormName            = 'BSCALEN';
export default () => {
    const urlBuscador     = "/bs/calendarios/search/" + sessionStorage.getItem('cod_empresa');
    const url_base        = "/bs/calendarios/" + sessionStorage.getItem('cod_empresa');

...
const url_lista         = '/bs/tipocomp/';
const columBuscador     = 'DESCRIPCION';
const doNotsearch       = ['ESTADO','LINEAS'];
const notOrderByAccion  = ['ACCION'];
const idACCION          = 'ACCIONES';
const columns = [
    { ID: "COD_MODULO"      , label: "Módulo"        , minWidth: 100, width:100, align: "left" },
    { ID: "TIP_COMPROBANTE" , label: "Tipo"          , minWidth: 100, width:100, align: "left" },
    { ID: "DESCRIPCION"     , label: "Descripcion"   , minWidth: 150, width:250, align: "left" },
    { ID: "ABREVIATURA"     , label: "Abreviatura"   , minWidth: 130, width:130, align: "left" },
    { ID: "LINEAS"          , label: "Líneas"        , minWidth: 100, width:100, align: "right" , alignID:"right"},
    { ID: "DESC_SALDOS"     , label: "Saldos"        , minWidth: 110, width:110, align: "left"  , alignID:"left"},
    { ID: "DESC_STOCK"      , label: "Stock"         , minWidth: 100, width:110, align: "left"  , alignID:"left"},
    { ID: "DESC_TIP_ORIGEN" , label: "Origen"        , minWidth: 100, width:100, align: "left"  , alignID:"left"},
    { ID: "ESTADO"          , label: "Activo"        , minWidth: 110, width:110, align: "center", alignID: "center" , checkbox:true, options:['A']},
];
const defaultOpenKeys     = sessionStorage.getItem("mode") == 'vertical' ? [] : ['BS','BS-BS1'];
const defaultSelectedKeys = sessionStorage.getItem("mode") == 'vertical' ? [] : ['BS-BS1-null-BSTIPCOM'];
const FormName            = 'BSTIPCOM';
export default () => {
    const urlBuscador   = "/bs/tipocomp/search/" + sessionStorage.getItem('cod_empresa');
    const url_base      = "/bs/tipocomp/" + sessionStorage.getItem('cod_empresa');

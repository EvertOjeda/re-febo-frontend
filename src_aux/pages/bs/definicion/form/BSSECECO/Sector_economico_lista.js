...
const url_lista         = '/bs/sector_economico/';
const urlBuscador       = "/bs/sectores_economicos/search";
const columBuscador     = 'DESCRIPCION';
const doNotsearch       = ['ACCION'];
const notOrderByAccion  = ['ACCION'];
const idACCION          = 'ACCIONES';
const columns = [
	{ ID: 'COD_SECTOR'	    , label: 'Codigo'   	, width: 100    },
	{ ID: 'DESCRIPCION'   	, label: 'Descripcion' 	, minWidth: 500 },
];
...
export default () =>{
    const url_base      = "/bs/sectores_economicos/"
